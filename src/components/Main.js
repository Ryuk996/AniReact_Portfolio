...
const Center = styled.button`
  ...
  outline: none;
  border-radius:50px;
  box-shadow: 0 0 10px 5px rgb(120, 248, 242);                                  //TODO
  background: rgb(120, 248, 242);
  cursor: pointer;
  display: flex;
...
const Contact = styled(NavLink)`
  color: ${(props) => (props.click ? DarkTheme.body : DarkTheme.text)};             //TODO
  position: absolute;
  top: 2rem;
  right: calc(1rem + 2vw);
...
const DarkDiv = styled.div`
  ...
  background-color: #000000;                                                    //TODO #000000
      ...
      >
        ...
        <Container>
          ...
          {/* {mq ? (
            ...
            <BLOG click={+false} onClick={() => setpath("blog")} to="/skills">
              <motion.h2
                initial={{
                  y: -200,
                  transition: { type: "spring", duration: 1.5, delay: 1 },
